...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
                ...
                <li class="nav-item">
                    ...
                    ?>
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="logoutdocter.php">Logout (<?php echo $_SESSION['nip'] ?>)</a>
                            </li>
                        </ul>
                    <?php
                    } else {
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4">
            <!-- Brand Logo -->
            <a href="dokterdashboard.php" class="brand-link">
            ...
            <div class="sidebar">
              ...
              with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="dokterdashboard.php" class="nav-link ">
                        ...
                        <li class="nav-item">
                            <a href="dokterdashboard.php?page=periksa" class="nav-link">
